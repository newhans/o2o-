...
import com.newhans.dao.ProductImgDao;
...
import com.newhans.web.shopadmin.ProductCategoryManagementController;
...
public class ProductServiceImpl implements ProductService{
	...
	private void addProductImgList(Product product, List<ImageHolder> productImgHolderList) {
		...
		for (ImageHolder productImageHolder : productImgHolderList) {
			String imgAddr = ImageUtil.generateNormalImage(productImageHolder, dest);
